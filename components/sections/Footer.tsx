      ...
      <div className="mx-auto max-w-7xl px-6 py-16 md:py-20">
        <div className="grid gap-12 md:grid-cols-4">
          ...
          <div className="md:col-span-1">
            <span className="font-display text-2xl font-bold tracking-wider text-text-primary">
              PRO <span className="text-gradient-gold">SET</span>
            </span>
            <p className="mt-4 text-sm leading-relaxed text-text-secondary">
              Transformamos momentos em memórias inesquecíveis há mais de uma
              década.
            </p>
            ...
            <div className="mt-6 flex gap-4">
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full border border-border
                  text-text-secondary transition-all duration-300 hover:border-accent-gold
        ...
        >
          <p className="text-xs text-text-muted">
            &copy; {currentYear} Pro Set Eventos. Todos os direitos reservados.
          </p>
          <p className="text-xs text-text-muted">
            Feito com dedicação para criar experiências únicas.
          </p>
        </motion.div>
      </div>
    </footer>
